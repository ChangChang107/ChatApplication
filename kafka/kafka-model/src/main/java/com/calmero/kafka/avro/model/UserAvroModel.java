 ...
 */
package com.calmero.kafka.avro.model;
...
public class UserAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7937602990104046173L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserAvroModel\",\"namespace\":\"com.calmero.kafka.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"}]},{\"name\":\"username\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"}]},{\"name\":\"createdAt\",\"type\":[\"null\",\"long\"],\"logicalType\":[\"null\",\"date\"]}]}");
   ...
   */
  public static com.calmero.kafka.avro.model.UserAvroModel.Builder newBuilder() {
    return new com.calmero.kafka.avro.model.UserAvroModel.Builder();
  }
   ...
   * @return A new UserAvroModel RecordBuilder
   */
  public static com.calmero.kafka.avro.model.UserAvroModel.Builder newBuilder(com.calmero.kafka.avro.model.UserAvroModel.Builder other) {
    if (other == null) {
      return new com.calmero.kafka.avro.model.UserAvroModel.Builder();
    } else {
      return new com.calmero.kafka.avro.model.UserAvroModel.Builder(other);
    }
  }
   ...
   * @return A new UserAvroModel RecordBuilder
   */
  public static com.calmero.kafka.avro.model.UserAvroModel.Builder newBuilder(com.calmero.kafka.avro.model.UserAvroModel other) {
    if (other == null) {
      return new com.calmero.kafka.avro.model.UserAvroModel.Builder();
    } else {
      return new com.calmero.kafka.avro.model.UserAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.calmero.kafka.avro.model.UserAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.calmero.kafka.avro.model.UserAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.calmero.kafka.avro.model.UserAvroModel.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.calmero.kafka.avro.model.UserAvroModel.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.calmero.kafka.avro.model.UserAvroModel.Builder setName(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.calmero.kafka.avro.model.UserAvroModel.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.calmero.kafka.avro.model.UserAvroModel.Builder setUsername(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.calmero.kafka.avro.model.UserAvroModel.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.calmero.kafka.avro.model.UserAvroModel.Builder setCreatedAt(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.calmero.kafka.avro.model.UserAvroModel.Builder clearCreatedAt() {
      createdAt = null;
